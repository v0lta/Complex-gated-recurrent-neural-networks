...
p1 = base_path2 + '2018-05-25 22:28:12_memory_250_1000000_10000_112_0.001_50_clipping_True_UnitaryCell__activation_mod_relu__arjovski_basis_False__real_cell_False_nat_grad_rms_False_qr_steps_None_pt_29345'
...
plot_logs(psf, ['uRNN', 'GRU', 'cgRNN'],
          ...
          tikz=False, pdf=True, filename='icvss_memory.pdf',
          log=False)
plt.gcf().clear()

# adding problem evaluation.
p1 = base_path2 + '2018-05-25 15:56:36_adding_250_1000000_10000_112_0.001_50_clipping_True_UnitaryCell__activation_mod_relu__arjovski_basis_False__real_cell_False_nat_grad_rms_False_qr_steps_None_pt_25985'
...
plot_logs(psf, ['uRNN', 'GRU', 'cgRNN'],
          ...
          tikz=False, pdf=True, filename='icvss_adding.pdf',
          log=False)
plt.gcf().clear()
